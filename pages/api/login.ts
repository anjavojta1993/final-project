...
export default async function Login(
  ...
  if (req.method === 'POST') {
    ...
    // Save the token to the database with a time limit (automatically generated expiry of 24 hours)
    // write insertSession function in database.ts
    ...
    return (
      res
        .status(200)
        // setting cookies on the server side, this sets the cookie in the header
